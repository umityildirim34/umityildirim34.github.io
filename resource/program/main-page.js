...
var imgMobile = document.getElementById("map-img-mobile");
var imgWeb = document.getElementById("map-img-web");
...
fetch(strUrl).then(res => res.json()).then(datas => {
    ...
    imgMobile.alt = datas.sve_map_mainpage.sve_map_wgt_img_mobile;
    imgWeb.alt = datas.sve_map_mainpage.sve_map_wgt_img_web;
...
lnEmail.innerHTML = "umityildirim3410@gmail.com";
